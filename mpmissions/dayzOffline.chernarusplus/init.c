...
void main()
{
	SpawnObject("MCK_KeyGrinder", "10132.4 230.946 5189.54", "-31.9046 -0.000000 -0.000000");
	SpawnObject("MCK_KeyGrinder", "10131.2 230.946 5188.81", "-31.9046 -0.000000 -0.000000");
...
//	weather.GetFog().Set( Math.RandomFloatInclusive(0.05, 0.1), 1, 0);
	...
	int reset_month = 11, reset_day = 10;
